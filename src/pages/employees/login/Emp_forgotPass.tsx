...
import { Employee_post_forgot_password } from "../../../reducers/employees/EmployeeApicalls";
const Emp_forgotPass = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      if (password !== confirmPassword) {
        ...
        setError("");
        dispatch(Employee_post_forgot_password({ email, password }))
          .unwrap()
          .then(() => {
