...
import { User_put_addLocation, userLoginPost } from "../../../reducers/users/UserapiCalls";
...
const UserLogin = () => {
  ...
  useEffect(() => {
    ...
    if (isSuccess) {
      ...
      if(user&&location){
        ...
        dispatch(User_put_addLocation({id:user.id,location}))
  ...
  }, [isError, isSuccess, message, dispatch, navigate,location,user]);
