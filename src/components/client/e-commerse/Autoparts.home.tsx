...
import { User_get_allCategories, User_get_allProductwithStoreId } from "../../../reducers/users/UserapiCalls";
...
const AutopartsHome: React.FC = () => {
  ...
  return (
    <>
    {
      ...
      <AddtoCartModal onClose={()=>setAddtoCartModal(false)} product={addtoCartProduct}  delivary={Number(distance)}/>
    }
            ...
            {filteredProducts?.map((item) => (
              ...
              className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300"
                ...
                <div className="relative">
                  ...
                  >
                    <FaHeart className={`text-xl ${wishlist[item.id] ? "text-red-500" : ""}`} />
                  </motion.button>
                </div>
                <div className="p-4">
