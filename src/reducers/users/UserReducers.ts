...
const userSlices=createSlice({
    ...
    extraReducers:(builder) =>{
        ...
        .addCase(UsersendOtpMail.fulfilled,(state,action:PayloadAction<UserStateTypes>)=>{
            state.isLoading=false
            state.isSuccess=true
            state.isError=false
                    ...
                    if (action.payload) {
                        ...
                        state.message = "An unknown error occurred";
                         ...
                         .addCase(User_get_allJobs.pending,(state)=>{
                                      ...
                                      .addCase(User_get_allJobs.fulfilled,(state,action:PayloadAction<JobsStateTypes[]>)=>{
                                          state.isLoading=false
                                          state.isSuccess=true
                                      ...
                                      .addCase(User_get_allJobs.rejected,(state,action)=>{
                                        ...
                                        .addCase(User_get_Employees.fulfilled,(state,action:PayloadAction<EmployeeStateTypes[]>)=>{
                                                  state.isLoading=false
                                                  state.isSuccess=true;
                                      ...
                                      .addCase(user_post_Service_Booking.fulfilled,(state,action:PayloadAction<ServiceBooking_Types>)=>{
                                                state.isLoading=false
                                                state.isSuccess=true;
...
export const {reset,clearUser,setTempuser,clearTempuser,selectEmployee}=userSlices.actions
